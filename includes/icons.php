...
function npad_icon_paths(): array
{
    return [
        ...
        'image-caption' => '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="1.8"/><path d="m21 15-4-4-9 9"/><path d="M5 21h14"/>',
        ...
        'image-remove'  => '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="2"/><path d="m21 15-4-4-6 6"/><path d="m5 19 5.5-5.5"/>',
        'image-alt'     => '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 9h18"/><path d="M7 13h6M7 16h10"/>',
        'image-advanced' => '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="10" r="2"/><path d="m21 15-4-4-6 6"/><path d="M12 20h9"/>',
        'crop'          => '<path d="M6 2v14a2 2 0 0 0 2 2h14"/><path d="M2 6h14a2 2 0 0 1 2 2v14"/>',
        'rotate'        => '<path d="M21 12a9 9 0 1 1-3-6.7"/><path d="M21 3v6h-6"/>',
        'layout'        => '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 9h18"/><circle cx="7" cy="6.5" r="0.8"/><path d="M7 10h8v4H7z"/>',
        'adjust'        => '<path d="M4 8h6M14 8h6"/><circle cx="12" cy="8" r="3"/><path d="M4 16h6M14 16h6"/><circle cx="12" cy="16" r="3"/>',
        'grayscale'     => '<circle cx="12" cy="12" r="9"/><path d="M12 3a9 9 0 0 0 0 18z" fill="currentColor"/>',
        'image-inline'  => '<rect x="3" y="5" width="12" height="10" rx="2"/><path d="M3 7h12M3 13h12"/><path d="M17 8h4M17 16h4M3 20h18"/>',
        'image-break'   => '<rect x="4" y="4" width="16" height="10" rx="2"/><path d="M3 18h18M3 16h18" stroke-width="1.6"/>',
        'image-front'   => '<rect x="3" y="8" width="14" height="12" rx="2"/><rect x="8" y="4" width="12" height="10" rx="2" fill="currentColor"/>',
        'image-behind'  => '<rect x="8" y="4" width="13" height="11" rx="2" stroke-dasharray="3 2"/><rect x="3" y="9" width="14" height="12" rx="2" fill="currentColor"/>',
