...
function npad_icon_paths(): array
{
    return [
        ...
        'section'     => '<rect x="4" y="4" width="16" height="6" rx="1"/><path d="M4 15h16"/><path d="M4 19h10"/>',
        'check-square' => '<rect x="4" y="4" width="16" height="16" rx="2"/><path d="m9 12 2 2 4-4"/>',
        'outline'     => '<path d="M4 5h16"/><path d="M7 12h13"/><path d="M10 19h10"/>',
