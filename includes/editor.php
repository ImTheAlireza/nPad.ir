...
$jsStrings = [
    ...
    'linkNewTab'        => t('dialog.link_new_tab'),
    'linkInvalid'       => t('dialog.link_invalid'),
    'exportUnavailable' => t('dialog.export_unavailable'),
    ...
    'checklistPlaceholder' => t('checklist.placeholder'),
    ...
    'aiApplied'         => t('ai.applied'),
    'aiNoteCreated'     => t('ai.note_created'),
    'aiTodosInserted'   => t('ai.todos_inserted'),
    'aiUndone'          => t('ai.undone'),
    'aiUndo'            => t('ai.undo'),
    'aiRedo'            => t('ai.redo'),
    'aiApply'           => t('ai.apply'),
    ...
    'aiHtmlResponse'    => t('ai.html_response'),
    'aiEmptyLength'     => t('ai.empty_length'),
    'aiReasoningOnly'   => t('ai.reasoning_only'),
    'aiWrongShape'      => t('ai.wrong_shape'),
    ...
    'aiTextToTable'     => t('ai.text_to_table'),
    'aiTextToTableNeedsSelection' => t('ai.text_to_table_needs_selection'),
    'aiTextToTableNotTabular'     => t('ai.text_to_table_not_tabular'),
