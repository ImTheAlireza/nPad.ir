...
return [
    ...
    'image' => [
        ...
        'size_custom'   => 'Custom width…',
        'layout_start'  => 'Align image to start',
        'layout_center' => 'Center image',
        'layout_end'    => 'Align image to end',
        'wrap'          => 'Text wrapping…',
        'layout_wrap_start' => 'Wrap text at start',
        'layout_wrap_end' => 'Wrap text at end',
        'wrap_hint'     => 'Wrapping is limited to 60% width and becomes a normal block on narrow screens.',
        'describe_title' => 'Describe image',
        'details_title' => 'Image details',
        'alt'           => 'Alternative text',
        'alt_hint'      => 'Describe the information this image adds. Do not use the filename.',
        'decorative'    => 'This image is decorative',
        'caption'       => 'Caption (optional)',
        'layout'        => 'Layout',
        'layout_block'  => 'Block',
        'width'         => 'Width',
        'width_unit'    => '% of editor width',
        'save_details'  => 'Save details',
        'description_needed' => 'Image description needed',
        'decorative_label' => 'Decorative image',
        'missing'       => 'Image data is unavailable on this device.',
        'crop_title'    => 'Crop image',
        'crop_hint'     => 'Drag the crop frame or enter exact values. Changes are not applied until you choose Apply.',
        'crop_original' => 'Original',
        'crop_square'   => '1:1',
        'crop_four_three' => '4:3',
        'crop_sixteen_nine' => '16:9',
        'crop_x'        => 'Left',
        'crop_y'        => 'Top',
        ...
        'rotation_unavailable' => 'This browser cannot rotate that image safely.',
        'rotation_animated_unsupported' => 'Animated GIFs cannot be rotated without flattening their animation.',
        'too_large'     => 'That image is larger than 25 MB.',
        'too_many_pixels' => 'That image is too large to edit safely.',
        'unsupported'   => 'Choose a valid PNG, JPEG, GIF, WebP, AVIF, or BMP image.',
        'type_mismatch' => 'The file type does not match its image data.',
        'invalid'       => 'That image could not be decoded safely.',
        'storage_failed' => 'The image could not be saved on this device.',
        'inserted'      => 'Image inserted. Add a description or mark it decorative.',
        'handle_nw'     => 'Resize image from top left',
        'handle_ne'     => 'Resize image from top right',
        'handle_sw'     => 'Resize image from bottom left',
        'handle_se'     => 'Resize image from bottom right',
    ],
