...
return [
    ...
    'image' => [
        ...
        'align_left'    => 'Align image left',
        'align_center'  => 'Center image',
        'align_right'   => 'Align image right',
        'alt_caption'   => 'Alt text, caption, size and alignment…',
        'replace'       => 'Replace image…',
        'remove'        => 'Remove image',
        'dialog_title'  => 'Image properties',
        'advanced'      => 'Image properties…',
        'rotate'        => 'Rotate 90° left',
        'layout_wrap'   => 'Toggle text wrapping',
        'recolor_grayscale_quick' => 'Grayscale / original',
        'section_text'  => 'Text',
        'section_size'  => 'Size & rotation',
        'section_layout' => 'Layout & anchoring',
        'section_crop'  => 'Cropping',
        'section_margins' => 'Margins from text',
        'section_adjust' => 'Recolor & adjustments',
        'section_border' => 'Border & effects',
        'layout_inline' => 'Inline with text',
        'layout_wrap'   => 'Wrap text',
        'layout_break'  => 'Break text',
        'layout_behind' => 'Behind text',
        'layout_front'  => 'In front of text',
        'layout_fixed'  => 'Fixed on page',
        'anchor'        => 'Position relative to',
        'anchor_paragraph' => 'Move with text (top left of paragraph)',
        'anchor_page'   => 'Fix position on page',
        'layout_hint'   => 'Absolute placements (behind, in front, fixed) anchor to the paragraph or the page; drag the image to move it.',
        'pos_x'         => 'Horizontal offset (px)',
        'pos_y'         => 'Vertical offset (px)',
        ...
        'recolor_none'  => 'None',
        'recolor_grayscale' => 'Grayscale',
        'recolor_sepia' => 'Sepia',
        'recolor_negative' => 'Negative',
        'recolor_faded' => 'Faded',
        'recolor_cool'  => 'Cool',
        'recolor_warm'  => 'Warm',
        'opacity'       => 'Opacity',
        ...
        'alt'           => 'Alt text (accessible description)',
        'caption'       => 'Caption',
        'size'          => 'Size',
        ...
        'align_center'  => 'Center',
        'align_right'   => 'Right',
        'too_large'     => 'That image is larger than 25 MB and was not added.',
        'unsupported'   => 'Only PNG, JPEG, GIF, WebP, AVIF and BMP images are supported.',
        'storage_failed' => 'The image could not be saved to local storage.',
        'missing'       => 'Image data is no longer available.',
    ],
